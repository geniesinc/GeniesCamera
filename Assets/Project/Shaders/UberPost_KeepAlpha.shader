Shader "Hidden/Universal Render Pipeline/UberPost_KeepAlpha"
{
    HLSLINCLUDE
        ...
        half4 FragUberPost(Varyings input) : SV_Target
        {
            ...
            if(CanDebugOverrideOutputColor(half4(color, SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, uv).a), uv, debugColor))
            {
                return debugColor;
            }
            #endif
            ...
            // https://discussions.unity.com/t/post-processing-truns-off-cameras-solid-color-alpha/666407/9
